    ...
    public function run()
    {
        ...
        DB::table('menu')->insert([
            ...
            [
                ...
                'stok' => 40,
                'status' => 1,
                'foto' => 'uploads/menu/Sate_Ayam.jpg',
                'deskripsi' => 'Sate ayam dengan bumbu kacang yang gurih dan lezat.',
                'kategory_id' => 1,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 20,
                'status' => 1,
                'foto' => 'uploads/menu/Gulai_Kambing.jpg',
                'deskripsi' => 'Gulai kambing dengan kuah santan kaya rempah.',
                'kategory_id' => 1,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                'menu_id' => 10,
                'nama_menu' => 'Nasi Liwet Komplit',
                'harga' => 20000.00,
                'stok' => 30,
                'status' => 1,
                'foto' => 'uploads/menu/Nasi_Liwet_Komplit.jpg',
                'deskripsi' => 'Nasi liwet dengan lauk pauk lengkap seperti ayam goreng dan sambal.',
                'kategory_id' => 1,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                'menu_id' => 14,
                'nama_menu' => 'Singkong Keju',
                'harga' => 6000.00,
                'stok' => 30,
                'status' => 1,
                'foto' => 'uploads/menu/Singkong_Keju.jpg',
                'deskripsi' => 'Singkong goreng renyah dengan taburan keju.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                'menu_id' => 15,
                'nama_menu' => 'Bakwan Jagung',
                'harga' => 4000.00,
                'stok' => 50,
                'status' => 1,
                'foto' => 'uploads/menu/Bakwan_Jagung.jpg',
                'deskripsi' => 'Bakwan jagung goreng yang renyah dan gurih.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                'menu_id' => 16,
                'nama_menu' => 'Cimol Bandung',
                'harga' => 5000.00,
                'stok' => 40,
                'status' => 1,
                'foto' => 'uploads/menu/Cimol_Bandung.jpg',
                'deskripsi' => 'Cimol khas Bandung yang kenyal dengan taburan bumbu pedas.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 35,
                'status' => 1,
                'foto' => 'uploads/menu/Keripik_Pisang.jpg',
                'deskripsi' => 'Keripik pisang dengan rasa manis dan renyah.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                'menu_id' => 18,
                'nama_menu' => 'Keripik Tempe',
                'harga' => 10000.00,
                'stok' => 40,
                'status' => 1,
                'foto' => 'uploads/menu/Keripik_Tempe.jpg',
                'deskripsi' => 'Keripik tempe yang renyah dengan rasa gurih.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                'menu_id' => 19,
                'nama_menu' => 'Cireng Sambal Rujak',
                'harga' => 8000.00,
                'stok' => 30,
                'status' => 1,
                'foto' => 'uploads/menu/Cireng_Sambal_Rujak.jpg',
                'deskripsi' => 'Cireng dengan sambal rujak yang pedas dan manis.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 25,
                'status' => 1,
                'foto' => 'uploads/menu/Onde-onde.jpg',
                'deskripsi' => 'Onde-onde dengan isian kacang hijau yang manis.',
                'kategory_id' => 2,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 50,
                'status' => 1,
                'foto' => 'uploads/menu/Es_Cendol.jpg',
                'deskripsi' => 'Es cendol dengan gula aren dan santan yang menyegarkan.',
                'kategory_id' => 3,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 45,
                'status' => 1,
                'foto' => 'uploads/menu/Es_Campur.jpg',
                'deskripsi' => 'Es campur dengan berbagai buah segar dan sirup manis.',
                'kategory_id' => 3,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 50,
                'status' => 1,
                'foto' => 'uploads/menu/Es_Kelapa_Muda.jpg',
                'deskripsi' => 'Es kelapa muda yang menyegarkan dengan tambahan sirup.',
                'kategory_id' => 3,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 35,
                'status' => 1,
                'foto' => 'uploads/menu/Es_Soda_Gembira.jpg',
                'deskripsi' => 'Es soda gembira dengan susu dan sirup manis.',
                'kategory_id' => 3,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 30,
                'status' => 1,
                'foto' => 'uploads/menu/Milkshake_Coklat.jpg',
                'deskripsi' => 'Milkshake coklat dengan tekstur lembut dan manis.',
                'kategory_id' => 3,
                'dibuat_oleh' => 2,
                'diperbarui_oleh' => 2,
                'created_at' => $date,
            ...
            [
                ...
                'stok' => 40,
                'status' => 1,
                'foto' => 'uploads/menu/Jus_Alpukat.jpg',
